...
这是一个 Minecraft Bedrock Edition 的多实例修改器

功能：

1. 为 Minercaft 启用多实例支持
...
This is a multi-instance modifier for Minecraft Bedrock Edition.

Features:

1. Enables multi-instance support for Minecraft.
